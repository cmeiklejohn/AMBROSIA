...
& dotnet $AMBROSIATOOLS\$AMBVARIANTCORERELEASE\AmbrosiaCS.dll CodeGen -a="ServerAPI\bin\$AMBVARIANTCORE\IServer.dll" -a="IClient1\bin\$AMBVARIANTCORE\IClient1.dll" -p="ServerAPI\IServer.csproj" p="IClient1\IClient1.csproj" -o=ServerInterfaces -f="net46" -f="netcoreapp2.0"
